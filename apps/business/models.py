...
class Business(models.Model):
    user = models.OneToOneField(User, verbose_name="账号",on_delete=models.DO_NOTHING)
    name = models.CharField(max_length=50, verbose_name="商家名称")
    position = models.IntegerField(choices=((1, "楚园食堂"), (2, "汉园食堂"), (3, "校内商家")), verbose_name="位置", db_index=True)
    floor = models.IntegerField(choices=((1, "一楼"), (2, "二楼"), (3, "竹枫斋楼下")), verbose_name="楼层")
...
class Food(models.Model):
    business = models.ForeignKey(Business, related_name='foodlist', verbose_name="商家",on_delete=models.DO_NOTHING)
...
class Special(models.Model):
    business = models.OneToOneField(Business, verbose_name="商家", related_name='special',on_delete=models.DO_NOTHING)
...
class Authapply(models.Model):
    user = models.OneToOneField(User, verbose_name="申请者",on_delete=models.DO_NOTHING)
...
class BusinessTextComment(models.Model):
    business = models.ForeignKey(Business, verbose_name="商家",on_delete=models.DO_NOTHING)
