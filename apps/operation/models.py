...
class Order(models.Model):
    user = models.ForeignKey(User, related_name='myorder', verbose_name="订单发起者",on_delete=models.DO_NOTHING)
    food = models.ForeignKey(Food, validators=[business_is_open_validator], verbose_name="订单食物",on_delete=models.DO_NOTHING)
...
class AbnormalOrder(models.Model):
    order = models.OneToOneField(Order, verbose_name="订单",on_delete=models.DO_NOTHING)
...
class BusinessOrderList(models.Model):
    business = models.OneToOneField(Business, verbose_name="商家", related_name="order_list",on_delete=models.DO_NOTHING)
...
class UserCollect(models.Model):
    user = models.OneToOneField(User, related_name='mycollect', verbose_name="用户",on_delete=models.DO_NOTHING)
